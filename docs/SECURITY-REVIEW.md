...
| Dense graphs and cycles | Tokenizer advances monotonically. Layout uses bounded queue processing and exactly six ordering sweeps. Traversals are iterative with visited sets. Self-loops and cycles terminate. |
